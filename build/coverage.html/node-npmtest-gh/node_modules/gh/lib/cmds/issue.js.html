...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-gh/node_modules/gh/lib/cmds/issue.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-gh/node_modules/gh/lib/cmds/issue.js</span></h1>
    <h2>
        
        Statements: <span class="metric">0.93% <small>(2 / 215)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        ...
        Lines: <span class="metric">0.93% <small>(2 / 215)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-gh/node_modules/gh/lib/cmds/</a> &#187; issue.js</div>
</div>
<div class="body">
...
// -- Constructor ----------------------------------------------------------------------------------
&nbsp;
<span class="fstat-no" title="function not covered" >function Issue(options) {</span>
...
// -- Constants ------------------------------------------------------------------------------------
&nbsp;
<span class="cstat-no" title="statement not covered" >Issue.DETAILS = {</span>
    alias: 'is',
...
&nbsp;
<span class="cstat-no" title="statement not covered" >Issue.STATE_CLOSED = 'closed';</span>
<span class="cstat-no" title="statement not covered" >Issue.STATE_OPEN = 'open';</span>
&nbsp;
// -- Commands -------------------------------------------------------------------------------------
&nbsp;
<span class="cstat-no" title="statement not covered" >Issue.prototype.run = <span class="fstat-no" title="function not covered" >function () {</span></span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >            logger.log('Closing issue ' + logger.colors.green('#' + options.number) +</span>
...
<span class="cstat-no" title="statement not covered" >            logger.log('Listing ' + logger.colors.green(options.state) + ' issues for ' +</span>
...
<span class="cstat-no" title="statement not covered" >            logger.log('Listing ' + logger.colors.green(options.state) +</span>
...
<span class="cstat-no" title="statement not covered" >            logger.log('Creating a new issue on ' + logger.colors.green(options.user + '/' + options.repo));</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >            logger.log('Opening issue ' + logger.colors.green('#' + options.number) +</span>
                ' on ' + logger.colors.green(options.user + '/' + options.repo));
&nbsp;
...
<span class="cstat-no" title="statement not covered" >            logger.log('Searching for ' + logger.colors.green(options.search) +</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >Issue.prototype.browser = <span class="fstat-no" title="function not covered" >function (user, repo, number) {</span></span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    openUrl(config.github_host + user + '/' + repo + '/issues/' + number);</span>
};
&nbsp;
<span class="cstat-no" title="statement not covered" >Issue.prototype.close = <span class="fstat-no" title="function not covered" >function (opt_callback) {</span></span>
<span class="cstat-no" title="statement not covered" >    var instance = this;</span>
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >Issue.prototype.comment = <span class="fstat-no" title="function not covered" >function (opt_callback) {</span></span>
<span class="cstat-no" title="statement not covered" >    var instance = this,</span>
        options = instance.options,
        body,
        payload;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >Issue.prototype.editIssue_ = <span class="fstat-no" title="function not covered" >function (title, state, opt_callback) {</span></span>
<span class="cstat-no" title="statement not covered" >    var instance = this,</span>
        options = instance.options,
        payload;
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >Issue.prototype.getIssue_ = <span class="fstat-no" title="function not covered" >function (opt_callback) {</span></span>
<span class="cstat-no" title="statement not covered" >    var instance = this,</span>
        options = instance.options,
        payload;
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >Issue.prototype.list = <span class="fstat-no" title="function not covered" >function (user, repo, opt_callback) {</span></span>
<span class="cstat-no" title="statement not covered" >    var instance = this,</span>
        options = instance.options,
        operations = [],
        payload;
...
<span class="cstat-no" title="statement not covered" >                        logger.debug('Milestone ' + milestone.title + ' number: ' + milestone.number);</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >                logger.log(logger.colors.green('#' + issue.number) + ' ' + issue.title + ' ' +</span>
...
<span class="cstat-no" title="statement not covered" >                        logger.log(logger.colors.green('milestone: ') +</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >Issue.prototype.listFromAllRepositories = <span class="fstat-no" title="function not covered" >function (opt_callback) {</span></span>
<span class="cstat-no" title="statement not covered" >    var instance = this,</span>
        options = instance.options,
        payload;
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >Issue.prototype.new = <span class="fstat-no" title="function not covered" >function (opt_callback) {</span></span>
<span class="cstat-no" title="statement not covered" >    var instance = this,</span>
        options = instance.options,
        body,
        payload;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >Issue.prototype.open = <span class="fstat-no" title="function not covered" >function (opt_callback) {</span></span>
<span class="cstat-no" title="statement not covered" >    var instance = this;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    instance.getIssue_(<span class="fstat-no" title="function not covered" >function (err, issue) {</span></span>
<span class="cstat-no" title="statement not covered" >        if (err) {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >Issue.prototype.search = <span class="fstat-no" title="function not covered" >function (user, repo, opt_callback) {</span></span>
<span class="cstat-no" title="statement not covered" >    var instance = this,</span>
        options = instance.options,
        operations = [],
        query = [],
...
&nbsp;
<span class="cstat-no" title="statement not covered" >exports.Impl = Issue;</span>
&nbsp;
&nbsp;</pre></td></tr>
</table></pre>
</div>
